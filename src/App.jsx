      ...
      <div style={{ background: "#f8fafc", borderRadius: 24, width: "100%", maxWidth: 600, maxHeight: "90vh", overflowY: "auto", boxShadow: "0 24px 64px rgba(0,0,0,0.35)" }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ position: "sticky", top: 0, zIndex: 10, background: "#fff", borderBottom: "1px solid rgba(26,43,94,0.08)", borderRadius: "24px 24px 0 0", padding: "18px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <TaxIQLogo size={32} />
            <h2 style={{ color: navy, fontSize: "1.1rem", fontWeight: 900, margin: 0 }}>Σχετικά με το TaxIQ</h2>
          </div>
      ...
      <div style={{ background: "#f8fafc", borderRadius: 24, width: "100%", maxWidth: 580, maxHeight: "90vh", overflowY: "auto", boxShadow: "0 24px 64px rgba(0,0,0,0.35)" }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ position: "sticky", top: 0, zIndex: 10, background: "#fff", borderBottom: "1px solid rgba(26,43,94,0.08)", borderRadius: "24px 24px 0 0", padding: "18px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            ...
            <h2 style={{ color: navy, fontSize: "1.1rem", fontWeight: 900, margin: 0 }}>Πολιτική Cookies TaxIQ</h2>
          </div>
          <button onClick={onClose} style={{ background: "none", border: "none", fontSize: "1.4rem", cursor: "pointer", color: "#94a3b8" }}>✕</button>
        </div>
        ...
        <div style={{ padding: "20px 24px 32px" }}>
          ...
          <Section num="2" title="Ποια Cookies χρησιμοποιούμε;">
            <p style={{ margin: "0 0 12px" }}>Στο TaxIQ χρησιμοποιούμε τρεις κατηγορίες cookies:</p>
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 16, backdropFilter: "blur(4px)" }} onClick={onClose}>
      <div style={{ background: "#f8fafc", borderRadius: 24, width: "100%", maxWidth: 640, maxHeight: "90vh", overflowY: "auto", boxShadow: "0 24px 64px rgba(0,0,0,0.35)" }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ position: "sticky", top: 0, zIndex: 10, background: "#fff", borderBottom: "1px solid rgba(26,43,94,0.08)", borderRadius: "24px 24px 0 0", padding: "18px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ fontSize: "0.6rem", fontWeight: 700, color: teal, letterSpacing: "0.16em", textTransform: "uppercase", marginBottom: 3 }}>Νομικά</div>
            <h2 style={{ color: navy, fontSize: "1.1rem", fontWeight: 900, margin: 0 }}>Όροι Χρήσης TaxIQ</h2>
          </div>
          <button onClick={onClose} style={{ background: "none", border: "none", fontSize: "1.4rem", cursor: "pointer", color: "#94a3b8" }}>✕</button>
        </div>
        ...
        <div style={{ padding: "20px 24px 32px" }}>
          ...
          <div style={{ background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.3)", borderLeft: "4px solid #f59e0b", borderRadius: "0 10px 10px 0", padding: "12px 16px", marginBottom: 24 }}>
            ...
            <p style={{ fontSize: "0.78rem", color: "#92400e", margin: "4px 0 0", lineHeight: 1.6 }}>Παρακαλούμε διαβάστε προσεκτικά τους όρους χρήσης πριν χρησιμοποιήσετε την υπηρεσία μας. Η χρήση του TaxIQ συνεπάγεται την πλήρη και ανεπιφύλακτη αποδοχή των παρόντων όρων.</p>
          </div>
          ...
          <Section num="2" title="Περιγραφή Υπηρεσίας & Αποποίηση Ευθύνης (Disclaimer)">
            <p style={{ margin: "0 0 10px" }}>Το TaxIQ παρέχει πληροφόρηση σχετικά με την ελληνική φορολογική και λογιστική νομοθεσία μέσω τεχνολογίας Τεχνητής Νοημοσύνης (AI). Καταβάλλεται η μέγιστη δυνατή προσπάθεια, ώστε οι πληροφορίες να είναι ακριβείς, σαφείς, πλήρεις και επίκαιρες. Ωστόσο, ο χρήστης αναγνωρίζει και αποδέχεται τα εξής:</p>
            <Bullet><strong style={{ color: navy }}>Φύση Πληροφοριών:</strong> Το TaxIQ παρέχει αποκλειστικά ενημερωτικές πληροφορίες και όχι εξατομικευμένη λογιστική, φοροτεχνική ή νομική συμβουλή. Οι απαντήσεις του AI δεν υποκαθιστούν σε καμία περίπτωση την επαγγελματική κρίση ενός εξειδικευμένου συμβούλου.</Bullet>
          ...
          <Section num="5" title="Διαδικασία Χρέωσης & Ανανέωσης">
            ...
            <Bullet><strong style={{ color: navy }}>Εξατομικευμένες Συμφωνίες (B2B):</strong> Για το Business Plan, το TaxIQ δύναται να προβεί σε ειδικές τιμολογήσεις κατόπιν έγγραφης συμφωνίας (SLA). Οι όροι της έγγραφης συμφωνίας υπερισχύουν των γενικών όρων.</Bullet>
          </Section>
          ...
          <Section num="8" title="Πνευματική Ιδιοκτησία">
            <p style={{ margin: "0 0 8px" }}>Με την επιφύλαξη δικαιωμάτων τρίτων, όλο το περιεχόμενο του TaxIQ (αλγόριθμος, σήματα, κείμενα, υπηρεσίες) αποτελεί πνευματική και βιομηχανική ιδιοκτησία και διέπεται από ελληνικές, ευρωπαϊκές και διεθνείς διατάξεις. Απαγορεύεται οποιαδήποτε τροποποίηση, δημοσίευση, μετάδοση, αναπαραγωγή ή εκμετάλλευση με οποιονδήποτε τρόπο ή μέσο για εμπορικούς ή άλλους σκοπούς, χωρίς προηγούμενη έγγραφη άδεια.</p>
          ...
          <Section num="9" title="Αναστολή & Τερματισμός Υπηρεσιών">
            <p style={{ margin: "0 0 8px" }}>Το TaxIQ διατηρεί το δικαίωμα αναστολής ή τερματισμού πρόσβασης χωρίς προηγούμενη ειδοποίηση σε περιπτώσεις:</p>
  ...
  const faqs = [
    {
      ...
      a: "Το TaxIQ λειτουργεί με τεχνολογία Real-Time Indexing. Σε αντίθεση με τα κοινά μοντέλα AI που έχουν περιορισμένη γνώση μέχρι μια συγκεκριμένη ημερομηνία, η πλατφόρμα μας σαρώνει και αναλύει ενεργά ΦΕΚ, εγκυκλίους και αποφάσεις της ΑΑΔΕ που δημοσιεύθηκαν ακόμη και σήμερα. Έτσι, έχετε πάντα την τελευταία λέξη του νόμου στην οθόνη σας."
    },
    {
                    ...
                    {faq.expert && (
                      <div>
                        <p style={{ fontSize: "0.84rem", color: "#475569", lineHeight: 1.7, margin: "0 0 12px" }}>
                          Είμαστε δίπλα σας. Αν και το TaxIQ είναι εξαιρετικά ακριβές, κατανοούμε ότι ορισμένα θέματα απαιτούν εξατομικευμένη προσέγγιση και επιβεβαίωση από ειδικό επαγγελματία.
                        </p>
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 16, backdropFilter: "blur(4px)" }} onClick={onClose}>
      <div style={{ background: "#f8fafc", borderRadius: 24, width: "100%", maxWidth: 940, boxShadow: "0 24px 64px rgba(0,0,0,0.35)", position: "relative", overflow: "hidden", maxHeight: "92vh", overflowY: "auto" }} onClick={e => e.stopPropagation()}>
        ...
        {/* Three-column plans */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14, padding: "20px 16px 24px" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "24px 16px", maxWidth: 760, width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
        {messages.length === 0 && (
          <div style={{ textAlign: "center", paddingTop: 40 }}>
            ...
            <h2 style={{ color: "#fff", fontSize: "1.6rem", fontWeight: 700, marginBottom: 8, letterSpacing: "-0.02em" }}>Tax<span style={{ color: orange }}>IQ</span></h2>
              ...
              <div style={{ maxWidth: 600, margin: "48px auto 0" }}>
                <div style={{ background: `linear-gradient(135deg, rgba(232,98,42,0.12) 0%, rgba(91,184,196,0.1) 100%)`, border: "1px solid rgba(232,98,42,0.25)", borderRadius: 20, padding: "32px 28px", textAlign: "center", position: "relative", overflow: "hidden" }}>
                  ...
                  <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "0.84rem", margin: "0 0 24px", lineHeight: 1.65 }}>
                    Γίνετε μέλος της κοινότητας του TaxIQ και αναβαθμίστε την ποιότητα των υπηρεσιών σας.
                  </p>
                  <button
            ...
            <div style={{ marginTop: 48, borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 40, paddingBottom: 24 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 32, marginBottom: 40, maxWidth: 900, margin: "0 auto 40px" }}>
                ...
                {/* TaxIQ */}
                <div>
                  <h4 style={{ color: "#fff", fontSize: "0.85rem", fontWeight: 700, marginBottom: 14, letterSpacing: "0.05em" }}>TaxIQ</h4>
              ...
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 20, maxWidth: 900, margin: "0 auto" }}>
                ...
                <div style={{ borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: 12, textAlign: "center" }}>
                  <p style={{ color: "rgba(255,255,255,0.18)", fontSize: "0.5rem", margin: 0, lineHeight: 1.65, fontStyle: "italic" }}>
                    <strong style={{ fontWeight: 600, fontStyle: "normal" }}>Αποποίηση Ευθύνης (Disclaimer):</strong>{" "}Οι απαντήσεις που παρέχονται από τον AI λογιστικό βοηθό του TaxIQ βασίζονται σε ανάλυση δεδομένων από επίσημες πηγές και την τρέχουσα νομοθεσία, ωστόσο έχουν αποκλειστικά ενημερωτικό και συμβουλευτικό χαρακτήρα. Παρά τη συνεχή προσπάθεια για την εγκυρότητα των πληροφοριών, η χρήση του TaxIQ δεν υποκαθιστά την εξατομικευμένη συμβουλή ενός πιστοποιημένου Λογιστή-Φοροτεχνικού ή Νομικού συμβούλου. Οι δημιουργοί του TaxIQ δεν φέρουν ευθύνη για τυχόν αποφάσεις που βασίζονται αποκλειστικά στις απαντήσεις της εφαρμογής. Συνιστάται πάντα η τελική επιβεβαίωση των στοιχείων πριν από οποιαδήποτε φορολογική ή επιχειρηματική ενέργεια.
                  </p>
                </div>
              </div>
            </div>
