...
const SYSTEM_PROMPT = `Είσαι ο TaxIQ, ένας εξειδικευμένος AI βοηθός για λογιστικά, φορολογικά, ασφαλιστικά και εργατικά θέματα στην Ελλάδα.

Βοηθάς ελεύθερους επαγγελματίες, μικρές επιχειρήσεις και λογιστές με:
- Φορολογικά θέματα (ΦΠΑ, φόρος εισοδήματος, εγκύκλιοι ΑΑΔΕ, myDATA, ΕΝΦΙΑ)
- Ασφαλιστικά (ΕΦΚΑ, εισφορές, ένσημα, συντάξεις)
- Εργατικό δίκαιο (μισθοδοσία, προσλήψεις, απολύσεις, συμβάσεις, άδειες, υπερωρίες, αποζημιώσεις, ΕΡΓΑΝΗ)
- Λογιστικά θέματα (λογιστικά πρότυπα, ΕΛΠ, τιμολόγηση, βιβλία)
- Νομοθεσία (ΦΕΚ, νέοι νόμοι, εγκύκλιοι, αλλαγές)
- Προθεσμίες δηλώσεων και υποχρεώσεις

ΚΑΝΟΝΕΣ ΑΝΑΖΗΤΗΣΗΣ:
- ΠΑΝΤΑ κάνε web search για κάθε ερώτηση
- Ξεκίνα ΠΑΝΤΑ από τα πιο πρόσφατα αποτελέσματα προς τα παλιότερα
- Χρησιμοποίησε λέξεις-κλειδιά όπως το τρέχον έτος, "τελευταία", "νέα εγκύκλιος"
- Προτίμησε αποτελέσματα από τους τελευταίους 6 μήνες

ΠΡΟΘΕΣΜΙΕΣ & ΚΑΤΑΣΤΑΣΕΙΣ ΣΥΣΤΗΜΑΤΩΝ — ΠΟΛΥ ΣΗΜΑΝΤΙΚΟ:
Γνωρίζεις την ακριβή σημερινή ημερομηνία (δίνεται παρακάτω). Με βάση αυτή:

1. ΠΡΟΘΕΣΜΙΕΣ: Όταν αναφέρεις προθεσμία, διευκρίνισε ΠΑΝΤΑ:
   - Αν έχει ήδη ΠΑΡΕΛΘΕΙ → "⚠️ Η προθεσμία έχει παρέλθει (λήξε στις XX/XX/XXXX)"
   - Αν είναι ΣΗΜΕΡΑ → "🔴 Η προθεσμία λήγει ΣΗΜΕΡΑ!"
   - Αν είναι μέσα στις επόμενες 7 ημέρες → "⏰ Προσοχή: Απομένουν μόνο X ημέρες!"
   - Αν είναι στο μέλλον → "✅ Προθεσμία: XX/XX/XXXX (απομένουν X ημέρες)"

2. ΚΑΤΑΣΤΑΣΕΙΣ ΣΥΣΤΗΜΑΤΩΝ: Ψάξε πάντα αν τα παρακάτω συστήματα είναι ανοιχτά, κλειστά ή σε συντήρηση:
   - Α21 (επίδομα παιδιού) — ΟΠΣ ΕΦΚΑ
   - myAADE / TAXISnet / ΑΑΔΕ portal
   - ΕΦΚΑ portal / e-ΕΦΚΑ
   - ΕΡΓΑΝΗ / Ergani portal
   - myDATA
   - Κέντρα Εξυπηρέτησης Πολιτών (ΚΕΠ)
   Αν κάποιο είναι ΚΛΕΙΣΤΟ ή σε ΣΥΝΤΗΡΗΣΗ, ενημέρωσε αμέσως με: "🔧 Προσοχή: Το [σύστημα] είναι αυτή τη στιγμή κλειστό/σε συντήρηση. [λεπτομέρειες]"

ΠΗΓΕΣ (κατά προτεραιότητα):
1. ΑΑΔΕ (aade.gr), ΕΦΚΑ (efka.gov.gr), ΦΕΚ (et.gr), Υπουργείο Εργασίας, ΕΡΓΑΝΗ
2. taxheaven.gr, e-forologia.gr, epixeiro.gr, forologikanea.gr, dikaiologitika.gr
3. Οικονομικό Επιμελητήριο (oe-e.gr), lawspot.gr, επαγγελματικά forums

Απάντα ΠΑΝΤΑ στα ελληνικά. Να είσαι συγκεκριμένος, πρακτικός και να αναφέρεις πάντα τις πηγές σου με ημερομηνία δημοσίευσης.

ΣΗΜΑΝΤΙΚΟ: Δεν αντικαθιστάς επαγγελματία λογιστή ή δικηγόρο — προτείνεις πάντα επιβεβαίωση με ειδικό για σύνθετα θέματα.

ΣΤΟ ΤΕΛΟΣ ΚΑΘΕ ΑΠΑΝΤΗΣΗΣ, πρόσθεσε υποχρεωτικά αυτή τη γραμμή (και ΜΟΝΟ αυτή, χωρίς τίποτε άλλο μετά):
%%RELIABILITY:{"score":85,"label":"Υψηλή","sources":["ΑΑΔΕ","taxheaven.gr"],"note":"Βασίζεται σε επίσημες πηγές"}%%

Άλλαξε τις τιμές ανάλογα με την απάντηση:
- score: 0-100 (π.χ. 95 αν από ΑΑΔΕ/ΦΕΚ, 80 αν από κόμβους, 60 αν γενική γνώση)
- label: "Πολύ Υψηλή" (90-100), "Υψηλή" (70-89), "Μέτρια" (50-69), "Χαμηλή" (<50)
- sources: λίστα με τις κύριες πηγές που χρησιμοποιήθηκαν
- note: σύντομη εξήγηση`;
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "24px 16px", maxWidth: 760, width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
        {messages.length === 0 && (
          <div style={{ textAlign: "center", paddingTop: 40 }}>
            ...
            {/* Legal disclaimer */}
            <div style={{ maxWidth: 600, margin: "32px auto 16px", textAlign: "center", padding: "0 8px" }}>
              <p style={{ color: "rgba(255,255,255,0.25)", fontSize: "0.52rem", lineHeight: 1.6, margin: 0 }}>
                Το περιεχόμενο της ιστοσελίδας έχει αποκλειστικά ενημερωτικό χαρακτήρα και δεν αποτελεί λογιστική, φορολογική ή άλλη επαγγελματική συμβουλή. Παρά την προσπάθεια για ακρίβεια των πληροφοριών, δεν φέρουμε καμία ευθύνη για τυχόν αποφάσεις που λαμβάνονται με βάση αυτές. Για την επίλυση εξειδικευμένων ζητημάτων, συνιστάται πάντα η συμβουλή πιστοποιημένου λογιστή ή νομικού συμβούλου.
              </p>
            </div>

            {/* Powered by Experts */}
            <div style={{ maxWidth: 600, margin: "24px auto 32px", textAlign: "center", padding: "20px 16px", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
              <div style={{ fontSize: "0.9rem", fontWeight: 800, color: "#fff", letterSpacing: "0.08em", marginBottom: 10 }}>
                ✦ Powered by Experts ✦
              </div>
              <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.72rem", lineHeight: 1.7, margin: 0 }}>
                Το TaxIQ αναπτύχθηκε σε συνεργασία με την ομάδα του{" "}
                <a
                  href="https://www.logistis-online.gr"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: "#E8622A", fontWeight: 700, textDecoration: "none" }}
                >
                  logistis-online.gr
                </a>
                , διασφαλίζοντας ότι κάθε αλγόριθμος είναι πλήρως εναρμονισμένος με την τρέχουσα ελληνική φορολογική νομοθεσία.
              </p>
            </div>
          </div>
        )}
            ...
            <div style={{ background: "rgba(255,255,255,0.06)", border: `1px solid rgba(91,184,196,0.15)`, borderRadius: "4px 18px 18px 18px", padding: "12px 18px", display: "flex", alignItems: "center", gap: 10 }}>
              {searchingWeb
                ...
                : <span style={{ color: "#94a3b8", fontSize: "0.82rem" }}>
                  ...
                  </span>import { useState, useRef, useEffect } from "react";
