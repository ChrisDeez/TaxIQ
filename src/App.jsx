        ...
        {mode !== "reset" && (
          <>
            <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "16px 0 12px" }}>
              ...
              <span style={{ fontSize: "0.72rem", color: "#94a3b8", whiteSpace: "nowrap" }}>ή συνέχεια με</span>
              <div style={{ flex: 1, height: 1, background: "#e2e8f0" }} />
            </div>
            <button
              onClick={async () => {
              ...
              style={{ width: "100%", padding: "10px 14px", background: "#fff", border: "1.5px solid #e2e8f0", borderRadius: 10, color: navy, fontSize: "0.9rem", fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontFamily: "inherit", transition: "border-color 0.2s" }}
  ...
  useEffect(() => {
    supabase.auth.getSession().then(({ data: { session } }) => {
      if (session?.user) {
        ...
        fetchSubscription(session.user.id, true);
      }
    });
